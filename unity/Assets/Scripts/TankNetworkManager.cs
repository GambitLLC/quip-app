...
public class TankNetworkManager : NetworkManager
{
    ...
    public static new TankNetworkManager singleton => (TankNetworkManager)NetworkManager.singleton;
    ...
    {
        Transform start = numPlayers == 0 ? spawn1 : spawn2;
        GameObject player = Instantiate(playerPrefab, start.position, start.rotation);
        
        TankMovement tankMovement = player.GetComponentInChildren<TankMovement>();
        tankMovement.isPlayer2 = numPlayers == 1;
        ...
        while (!conn.isReady)
        {
            //not sure if this is needed (julian)
        }
        gameManager.RpcSetPlayerId(numPlayers);
    }
